...
/**
     ...
     *
     */
function On(e){return null!=e&&"object"==typeof e&&null!=e.name&&"string"==typeof e.name&&null!=e.label&&"string"==typeof e.label&&["fixed","promise","observable","observableArray","function"].indexOf(e.type)>-1&&e.choices instanceof Array}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.createChoicesFunctionOrigin=function zn(e){return Object.assign(Object.assign({},e),{type:"function",label:e.label||"",choices:e.choices||[]})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.createChoicesObservableArrayOrigin=function Nn(e){return Object.assign(Object.assign({},e),{type:"observableArray",label:e.label||"",choices:e.choices||[]})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.createChoicesObservableOrigin=function In(e){return Object.assign(Object.assign({},e),{type:"observable",label:e.label||"",choices:e.choices||[]})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.createChoicesOrigin=an,e.createChoicesPromiseOrigin=function En(e){return Object.assign(Object.assign({},e),{type:"promise",label:e.label||"",choices:e.choices||[]})},e.createContainerNode=un,e.createField=H,e.createFieldInstance=_,e.createFieldWithChoicesInstance=$,e.createForm=
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.createFormPdf=function Zn(n,t,r){var o=function i(n,t,r){var o,i,a,s,u=function l(e){return null==e?function(e){return e}:function(n){return null==n||""===n||" "===n?" ":e.instant(n)}}(t),f=u(n.name),d=n.schema,c={};try{for(var A=O(d.choicesOrigins),p=A.next();!p.done;p=A.next()){var m=p.value;c[m.name]=m.choices}}catch(e){o={error:e}}finally{try{p&&!p.done&&(i=A.return)&&i.call(A)}finally{if(o)throw o.error}}var h=[{text:f,fontSize:22,bold:!0,alignment:"center",margin:[0,0,0,10]},{table:{widths:["*","*"],body:[[u("date start")+": "+(r?r.date_start:""),u("date end")+": "+(r?r.date_end:"")]]},layout:"noBorders"}];try{for(var v=O(d.nodes),j=v.next();!j.done;j=v.next()){var b=j.value;b.nodeType===e.AjfNodeType.AjfSlide?h.push.apply(h,z(gn(b,c,u,r))):b.nodeType===e.AjfNodeType.AjfRepeatingSlide&&h.push.apply(h,z(yn(b,c,u,r)))}}catch(e){a={error:e}}finally{try{j&&!j.done&&(s=v.return)&&s.call(v)}finally{if(a)throw a.error}}var g={info:{title:f},content:h};return n.is_tallysheet&&(g.pageOrientation="landscape"),g}(n,t,r);return h.createPdf(o,void 0,bn,jn)},e.createNode=Q,e.createNodeInstance=k,e.createValidation=se,e.createValidationGroup=ne,e.createWarning=ue,e.createWarningGroup=te,e.fieldIconName=Me,e.flattenNodes=fe,e.getTypeName=
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
function Rn(e){var n=typeof e;return"object"===n?e.constructor.toString().match(/\w+/g)[1]:n},e.initChoicesOrigin=N,e.isChoicesFixedOrigin=function Cn(e){return On(e)&&"fixed"===e.type}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.isChoicesOrigin=On,e.isContainerNode=X,e.isCustomFieldWithChoices=D,e.isField=E,e.isFieldWithChoices=I,e.isNumberField=function Fn(n){return n.fieldType===e.AjfFieldType.Number},e.isRepeatingContainerNode=re,e.isSlidesNode=U,e.maxDigitsValidation=function Gn(e){return se({condition:"$value ? $value.toString().length <= "+e.toString()+" : false",errorMessage:"Digits count must be <= "+e.toString()})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.maxValidation=function Wn(e){return se({condition:"$value <= "+e.toString(),errorMessage:"Value must be <= "+e.toString()})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.minDigitsValidation=function Vn(e){return se({condition:"$value ? $value.toString().length >= "+e.toString()+" : false",errorMessage:"Digits count must be >= "+e.toString()})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.minValidation=function Yn(e){return se({condition:"$value >= "+e.toString(),errorMessage:"Value must be >= "+e.toString()})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.notEmptyValidation=function qn(){return se({condition:"notEmpty($value)",errorMessage:"Value must not be empty"})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.notEmptyWarning=function Sn(){return ue({condition:"notEmpty($value)",warningMessage:"Value must not be empty"})},e.ɵ0=me,e.ɵgc_ajf_src_core_forms_forms_a=fn,e.ɵgc_ajf_src_core_forms_forms_b=dn,e.ɵgc_ajf_src_core_forms_forms_c=cn,e.ɵgc_ajf_src_core_forms_forms_d=B,Object.defineProperty(e,"__esModule",{value:!0})}));