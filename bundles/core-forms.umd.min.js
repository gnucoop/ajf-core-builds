...
/**
     ...
     *
     */
var y=function(){function e(){}return e.prototype.transform=function(e){return e},e}();y.decorators=[{type:n.Pipe,args:[{name:"ajfAsRepeatingSlideInstance"}]}];
/*! *****************************************************************************
...
/**
     ...
     *
     */
function u(e,n){return null==e.maxValue?null:"number"==typeof e.maxValue?{result:s.evaluateExpression("$value.length <= "+e.maxValue,{$value:n}),error:"Value must be <= "+e.maxValue,clientValidation:!1}:V(e.maxValue,{$value:n})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */(e,n);null!=l&&r.push(l)}if(e.minValue){var c=
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     *
     */
function le(e){var n=[];return e.forEach((function(e){n.push(e),z(e)&&(n=n.concat(le(e.nodes)))})),n}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     *
     */
function h(n){return null!=n&&M(n)&&function t(n){return n.fieldType===e.AjfFieldType.Table}(n.node)}(f)){var m=f,g=m.node;m.context=a[E(m)]||a;var y=this._formGroup.getValue(),v=[];v.push([o.label,g.columnLabels]),null!=y&&(g.rows.forEach((function(e,r){var o=[];e.forEach((function(e,i){var a=g.name+"__"+r+"__"+i,s={control:new t.FormControl,show:!1};s.control.setValue(m.context[e.formula]),y.registerControl(a,s.control),o.push(s);var l={formula:{formula:e.formula},node:{name:a,nodeType:0,editable:!1},visible:!0,prefix:[],conditionalBranches:[],updatedEvt:new n.EventEmitter};u._addToNodesFormulaMap(l,e.formula)})),v.push([g.rowLabels[r],o])})),m.controls=v)}else f.value=a[E(c)];!function b(e,n,t){void 0===t&&(t=!0),O(e,n,t),A(e,n),R(e,n),D(e,n),U(e,n),P(e,n)}(f,a)}}this._addNodeInstance(c)}return c},l.prototype._adjustReps=function(n,t,r,o){var i=this,a=t.reps,s={added:null,removed:null};if(r<a){var l=[];if(null==t.nodes&&(t.nodes=[]),t.node.nodeType===e.AjfNodeType.AjfNodeGroup){var u=G({id:999,name:"",parent:-1,fieldType:e.AjfFieldType.Empty,label:t.node.label}),c=this._initNodeInstance(n,u,t.prefix.slice(0),o);null!=c&&t.nodes.push(c)}for(var p=function(e){var r=t.prefix.slice(0),a=t.node;r.push(e),ue(a.nodes,t.node.id).forEach((function(e){var a=i._initNodeInstance(n,e,r,o);null!=a&&(l.push(a),t.nodes.push(a))})),d._addNodeInstance(t)},d=this,f=r;f<a;f++)p(f);s.added=l}else if(r>a){var h=t.nodes.length/r;t.node.nodeType===e.AjfNodeType.AjfNodeGroup&&h++,s.removed=t.nodes.splice(a*h,h),s.removed.forEach((function(e){i._removeNodeInstance(e)}))}if(r!=a&&null==t.formulaReps){var m=this._formGroup.getValue(),g=E(t);null!=m&&m.contains(g)&&m.controls[g].setValue(t.reps)}if(t.flatNodes=L(t.nodes),t.node.nodeType===e.AjfNodeType.AjfRepeatingSlide){var y=t,v=[],b=null!=y.nodes?y.nodes.length/y.reps:0;for(f=0;f<t.reps;f++){var _=f*b;v.push(t.nodes.slice(_,_+b))}y.slideNodes=v}return s},l.prototype._updateFormValueAndValidity=function(){this._nodesUpdates.pipe(o.withLatestFrom(this._formGroup),o.filter((function(e){return null!==C(e,2)[1]}))).subscribe((function(e){C(e,2)[1].updateValueAndValidity()}))},l.prototype._explodeRepeatingNode=function(e,n,t){var r=ce(n,t);r!==n.reps&&this._adjustReps(e,n,r,t)},l.prototype._orderedNodesInstancesTree=function(e,n,t,r,o){var i=this;void 0===t&&(t=null),void 0===r&&(r=[]);var a=[],s=r.length>0?"__"+r.join("__"):"";return ue(n,t).forEach((function(n){var t=a.find((function(e){return e.node.id==n.parent&&I(e)==s})),l=i._initNodeInstance(e,n,r,o,null==t||null!=t.verifiedBranch&&t.verifiedBranch==n.parentNode);null!=l&&a.push(l)})),a},l.prototype._formValueDelta=function(e,n){return Object.keys(n).filter((function(t){return e[t]!==n[t]}))},l.prototype._initFormGroupStreams=function(e){var n=this;this._formGroupSubscription.unsubscribe();var t=!0,i=!0;return this._formInitEvent.emit(0),this._formGroupSubscription=e.valueChanges.pipe(o.startWith({}),o.pairwise(),o.debounceTime(200),o.withLatestFrom.apply(void 0,x(this._nodesMaps,[this._flatNodes]))).subscribe((function(e){var o=t&&{}||e[0][0];t=!1;var a=e[0][1],l=e[1],u=e[2],c=e[3],p=e[4],d=e[5],f=e[6],h=e[7],m=e[8],g=e[9],y=e[10],v=n._formValueDelta(o,a),b=v.length,_=[];v.forEach((function(e){if(_=_.concat(y.filter((function(n){return E(n)===e}))),null!=l[e]&&l[e].forEach((function(e){var t=E(e),o=O(e,a),i=M(e);if(o&&!e.visible){var s=n._formGroup.getValue();if(null!=s)var l=r.timer(200).subscribe((function(){l&&!l.closed&&l.unsubscribe(),s.controls[t].setValue(null)}));i&&(e.value=null)}else if(o&&e.visible&&i){var u=n._formGroup.getValue(),c=R(e,a);null!=u&&c.changed&&u.controls[t].setValue(c.value)}-1===_.indexOf(e)&&_.push(e)})),null!=u[e]&&u[e].forEach((function(e){if(ne(e.node)){var t=e,r=ce(t,a);r!==t.reps&&n._adjustReps(y,t,r,a)}-1===_.indexOf(e)&&_.push(e)})),null!=c[e]&&c[e].forEach((function(e){A(e,a);var t=e.verifiedBranch;e.conditionalBranches.forEach((function(r,o){o==t?n._showSubtree(a,y,e,o):n._hideSubtree(a,y,e,o)})),-1===_.indexOf(e)&&_.push(e)})),null!=p[e]&&p[e].forEach((function(e){if(M(e)){var t=e,r=R(t,a),o=n._formGroup.getValue();null!=o&&r.changed&&(D(t,a),o.controls[E(e)].setValue(r.value))}-1===_.indexOf(e)&&_.push(e)})),null!=d[e]&&d[e].forEach((function(e){if(M(e)){var t=e;a.$value=a[E(e)],D(t,a,n.currentSupplementaryInformations)}-1===_.indexOf(e)&&_.push(e)})),null!=f[e]&&f[e].forEach((function(e){if(M(e)){var n=e;U(n,a),null!=n.warningResults&&n.warningResults.filter((function(e){return e.result})).length>0&&n.warningTrigger.emit()}-1===_.indexOf(e)&&_.push(e)})),1==b&&null!=h[e]&&1==h[e].filter((function(e){return!!M(e)&&P(e,a)})).length&&n._nextSlideTrigger.emit(),null!=m[e]&&m[e].forEach((function(e){if(M(e)){var n=e;F(n.node)&&B(n,a)}-1===_.indexOf(e)&&_.push(e)})),1==b&&null!=g[e]){var t=g[e].filter((function(e){if(!M(e))return!1;var n=e;return!!F(n.node)&&function t(e,n){if(null==e.triggerConditions)return!1;var t=E(e);if(e.firstTriggerConditionDone[t])return!1;for(var r=!1,o=e.triggerConditions.length,i=0;i<o;i++)if(s.evaluateExpression(e.triggerConditions[i].condition,n)){r=!0;break}return e.firstTriggerConditionDone[t]=r,r}(n,a)}));1==t.length&&t[0].selectionTrigger.emit()}})),_.forEach((function(e){for(var n=y.indexOf(e)-1;n>=0;){var t=y[n];H(t)&&(de(t),t.updatedEvt.emit()),n--}e.updatedEvt.emit()})),i&&(i=!1,n._formInitEvent.emit(1)),n._valueChanged.next()})),e},l.prototype._showSubtree=function(e,n,t,r){this._updateSubtreeVisibility(e,n,t,!0,r)},l.prototype._hideSubtree=function(e,n,t,r){this._updateSubtreeVisibility(e,n,t,!1,r)},l.prototype._updateSubtreeVisibility=function(e,n,t,r,o){var i,a=this,s=I(t);i=n.filter(null!=o?function(e){return I(e)==s&&e.node.parent==t.node.id&&e.node.parentNode==o}:function(e){return I(e)==s&&e.node.parent==t.node.id});var l=z(t.node);i.forEach((function(o){(!l||l&&null==t.node.nodes.find((function(e){return e.id==o.node.id})))&&(O(o,e,r),R(o,e),a._updateSubtreeVisibility(e,n,o,r))}))},l.prototype._initNodesStreams=function(){this._nodes=this._nodesUpdates.pipe(o.scan((function(e,n){return n(e)}),[]),o.share()),this._flatNodesTree=this._nodes.pipe(o.map((function(e){return function n(e){var n=[];return e.forEach((function(e){if(H(e)){var t=e;n.push(t),t.flatNodes=L(t.nodes)}})),n}(e)})),o.share()),this._flatNodes=this._flatNodesTree.pipe(o.map((function(e){var n=[];return e.forEach((function(e){n.push(e),n=n.concat(e.flatNodes),de(e)})),n})),o.share())},l.prototype._removeNodeInstance=function(e){var n=E(e);return this._removeNodesVisibilityMapIndex(n),this._removeNodesRepetitionMapIndex(n),this._removeNodesConditionalBranchMapIndex(n),this._removeNodesFormulaMapIndex(n),this._removeNodesValidationMapIndex(n),this._removeNodesWarningMapIndex(n),this._removeNodesNextSlideConditionsMapIndex(n),this._removeNodesFilteredChoicesMapIndex(n),this._removeNodesTriggerConditionsMapIndex(n),H(e)?this._removeSlideInstance(e):(ne(e.node)?this._removeNodeGroupInstance(e):M(e)&&this._removeFieldInstance(e),e)},l.prototype._removeSlideInstance=function(e){var n=this,t=e.node;return null!=t.visibility&&this._removeFromNodesVisibilityMap(e,t.visibility.condition),e.conditionalBranches.forEach((function(t){n._removeFromNodesConditionalBranchMap(e,t.condition)})),e},l.prototype._removeNodeGroupInstance=function(e){var n=e.node;return null!=n.visibility&&this._removeFromNodesVisibilityMap(e,n.visibility.condition),null!=e.formulaReps&&null!=n.formulaReps&&this._removeFromNodesRepetitionMap(e,n.formulaReps.formula),e},l.prototype._removeFieldInstance=function(e){var n=this,t=this._formGroup.getValue(),r=E(e);if(null!=t&&t.contains(r)&&t.removeControl(r),null!=e.validation&&this._validationNodesMapUpdates.next((function(e){return null==e[r]&&delete e[r],e})),null!=e.visibility&&this._removeFromNodesVisibilityMap(e,e.visibility.condition),e.conditionalBranches.forEach((function(t){n._removeFromNodesConditionalBranchMap(e,t.condition)})),e.formula&&this._removeFromNodesFormulaMap(e,e.formula.formula),ne(e.node)&&null!=e.formulaReps&&this._removeFromNodesRepetitionMap(e,e.formulaReps.formula),null!=e.validation&&null!=e.validation.conditions&&e.validation.conditions.forEach((function(t){n._removeFromNodesValidationMap(e,t.condition)})),null!=e.warning&&e.warning.conditions.forEach((function(t){n._removeFromNodesWarningMap(e,t.condition)})),null!=e.nextSlideCondition&&this._removeFromNodesNextSlideConditionsMap(e,e.nextSlideCondition.condition),F(e.node)){var o=e;null!=o.choicesFilter&&(this._removeFromNodesFilteredChoicesMap(e,o.choicesFilter.formula),null!=o.triggerConditions&&o.triggerConditions.forEach((function(t){n._removeFromNodesTriggerConditionsMap(e,t.condition)})))}return e},l.prototype._addNodeInstance=function(n){return ne(n.node)?this._addNodeGroupInstance(n):
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
function t(n){return null!=n&&null!=n.node&&function t(n){return null!=n&&n.nodeType===e.AjfNodeType.AjfSlide}(n.node)}(n)?this._addSlideInstance(n):M(n)?this._addFieldInstance(n):n},l.prototype._addFieldInstance=function(e){var n=this,r=this._formGroup.getValue(),o=E(e);if(null!=r&&!r.contains(o)){var i=new t.FormControl;i.setValue(e.value),r.registerControl(o,i)}if(null!=e.validation?this._validationNodesMapUpdates.next((function(n){return null==n[o]&&(n[o]=[]),-1==n[o].indexOf(e)&&n[o].push(e),n})):e.valid=!0,null!=e.visibility&&this._addToNodesVisibilityMap(e,e.visibility.condition),e.conditionalBranches.forEach((function(t){n._addToNodesConditionalBranchMap(e,t.condition)})),e.formula&&this._addToNodesFormulaMap(e,e.formula.formula),q(e)&&null!=e.formulaReps&&this._addToNodesRepetitionMap(e,e.formulaReps.formula),null!=e.validation&&null!=e.validation.conditions&&e.validation.conditions.forEach((function(t){n._addToNodesValidationMap(e,t.condition)})),null!=e.warning&&e.warning.conditions.forEach((function(t){n._addToNodesWarningMap(e,t.condition)})),null!=e.nextSlideCondition&&this._addToNodesNextSlideConditionsMap(e,e.nextSlideCondition.condition),W(e.node)||w(e)){var a=e;null!=a.choicesFilter&&this._addToNodesFilteredChoicesMap(e,a.choicesFilter.formula),null!=a.triggerConditions&&a.triggerConditions.forEach((function(t){n._addToNodesTriggerConditionsMap(e,t.condition)}))}return e},l.prototype._addSlideInstance=function(e){var n=this,t=e.node;return null!=t.visibility&&this._addToNodesVisibilityMap(e,t.visibility.condition),e.conditionalBranches.forEach((function(t){n._addToNodesConditionalBranchMap(e,t.condition)})),e},l.prototype._addNodeGroupInstance=function(e){var n=this,r=e.node;if(null!=r.visibility&&this._addToNodesVisibilityMap(e,r.visibility.condition),e.conditionalBranches.forEach((function(t){n._addToNodesConditionalBranchMap(e,t.condition)})),null!=e.formulaReps)null!=r.formulaReps&&this._addToNodesRepetitionMap(e,r.formulaReps.formula);else{var o=this._formGroup.getValue(),i=E(e);if(null!=o&&!o.contains(i)){var a=new t.FormControl;a.setValue(e.reps),o.registerControl(i,a)}}return e},l.prototype._removeNodesVisibilityMapIndex=function(e){this._removeNodesMapIndex(this._visibilityNodesMapUpdates,e)},l.prototype._removeNodesRepetitionMapIndex=function(e){this._removeNodesMapIndex(this._repetitionNodesMapUpdates,e)},l.prototype._removeNodesConditionalBranchMapIndex=function(e){this._removeNodesMapIndex(this._conditionalBranchNodesMapUpdates,e)},l.prototype._removeNodesFormulaMapIndex=function(e){this._removeNodesMapIndex(this._formulaNodesMapUpdates,e)},l.prototype._removeNodesValidationMapIndex=function(e){this._removeNodesMapIndex(this._validationNodesMapUpdates,e)},l.prototype._removeNodesWarningMapIndex=function(e){this._removeNodesMapIndex(this._warningNodesMapUpdates,e)},l.prototype._removeNodesFilteredChoicesMapIndex=function(e){this._removeNodesMapIndex(this._filteredChoicesNodesMapUpdates,e)},l.prototype._removeNodesTriggerConditionsMapIndex=function(e){this._removeNodesMapIndex(this._triggerConditionsNodesMapUpdates,e)},l.prototype._removeNodesNextSlideConditionsMapIndex=function(e){this._removeNodesMapIndex(this._nextSlideConditionsNodesMapUpdates,e)},l.prototype._removeNodesMapIndex=function(e,n){e.next((function(e){return Object.keys(e).indexOf(n)>-1&&delete e[n],e}))},l.prototype._removeFromNodesVisibilityMap=function(e,n){this._removeFromNodesMap(this._visibilityNodesMapUpdates,e,n)},l.prototype._removeFromNodesRepetitionMap=function(e,n){this._removeFromNodesMap(this._repetitionNodesMapUpdates,e,n)},l.prototype._removeFromNodesConditionalBranchMap=function(e,n){this._removeFromNodesMap(this._conditionalBranchNodesMapUpdates,e,n)},l.prototype._removeFromNodesFormulaMap=function(e,n){this._removeFromNodesMap(this._formulaNodesMapUpdates,e,n)},l.prototype._removeFromNodesValidationMap=function(e,n){this._removeFromNodesMap(this._validationNodesMapUpdates,e,n)},l.prototype._removeFromNodesWarningMap=function(e,n){this._removeFromNodesMap(this._warningNodesMapUpdates,e,n)},l.prototype._removeFromNodesFilteredChoicesMap=function(e,n){this._removeFromNodesMap(this._filteredChoicesNodesMapUpdates,e,n)},l.prototype._removeFromNodesTriggerConditionsMap=function(e,n){this._removeFromNodesMap(this._filteredChoicesNodesMapUpdates,e,n)},l.prototype._removeFromNodesNextSlideConditionsMap=function(e,n){this._removeFromNodesMap(this._nextSlideConditionsNodesMapUpdates,e,n)},l.prototype._removeFromNodesMap=function(e,n,t){var r=a.tokenize(t).filter((function(e){return"Identifier"==e.type&&"$value"!=e.value}));r.length>0&&e.next((function(e){return r.forEach((function(t){var r=t.value;if(null!=e[r]){var o=e[r].indexOf(n);o>-1&&(e[r].splice(o,1),0==e[r].length&&delete e[r])}})),e}))},l.prototype._addToNodesVisibilityMap=function(e,n){this._addToNodesMap(this._visibilityNodesMapUpdates,e,n)},l.prototype._addToNodesRepetitionMap=function(e,n){this._addToNodesMap(this._repetitionNodesMapUpdates,e,n)},l.prototype._addToNodesConditionalBranchMap=function(e,n){this._addToNodesMap(this._conditionalBranchNodesMapUpdates,e,n)},l.prototype._addToNodesFormulaMap=function(e,n){this._addToNodesMap(this._formulaNodesMapUpdates,e,n)},l.prototype._addToNodesValidationMap=function(e,n){this._addToNodesMap(this._validationNodesMapUpdates,e,n)},l.prototype._addToNodesWarningMap=function(e,n){this._addToNodesMap(this._warningNodesMapUpdates,e,n)},l.prototype._addToNodesFilteredChoicesMap=function(e,n){this._addToNodesMap(this._filteredChoicesNodesMapUpdates,e,n)},l.prototype._addToNodesTriggerConditionsMap=function(e,n){this._addToNodesMap(this._triggerConditionsNodesMapUpdates,e,n)},l.prototype._addToNodesNextSlideConditionsMap=function(e,n){this._addToNodesMap(this._nextSlideConditionsNodesMapUpdates,e,n)},l.prototype._addToNodesMap=function(e,n,t){var r=a.tokenize(t).filter((function(e){return"Identifier"==e.type&&"$value"!=e.value}));r.length>0&&e.next((function(e){return r.forEach((function(t){var r=t.value;null==e[r]&&(e[r]=[]),-1===e[r].indexOf(n)&&e[r].push(n)})),e}))},l}();he.decorators=[{type:n.Injectable}],he.ctorParameters=function(){return[{type:pe}]};var me=function(){function e(e,n,i){var a=this;this._changeDetectorRef=e,this._service=n,this._warningAlertService=i,this._warningTriggerSub=r.Subscription.EMPTY,this._instanceUpdateSub=r.Subscription.EMPTY,this._control=r.defer((function(){return a._service.getControl(a.instance).pipe(o.map((function(e){return e||new t.FormControl})))}))}return Object.defineProperty(e.prototype,"instance",{get:function(){return this._instance},set:function(e){e!==this._instance&&(this._instance=e,this._setUpInstanceUpdate(),this._onInstanceChange())},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"control",{get:function(){return this._control},enumerable:!1,configurable:!0}),e.prototype.ngOnInit=function(){var e=this;this._warningTriggerSub=this.instance.warningTrigger.pipe(o.withLatestFrom(this.control),o.filter((function(e){return null!=C(e,2)[1]}))).subscribe((function(n){var t=C(n,2);if(null!=e.instance.warningResults)var r=t[1],o=e._warningAlertService.showWarningAlertPrompt(e.instance.warningResults.filter((function(e){return e.result})).map((function(e){return e.warning}))).subscribe((function(e){e.result&&r.setValue(null)}),(function(e){o&&o.unsubscribe()}),(function(){o&&o.unsubscribe()}))}))},e.prototype.ngOnDestroy=function(){this._warningTriggerSub.unsubscribe(),this._instanceUpdateSub.unsubscribe()},e.prototype._onInstanceChange=function(){},e.prototype._setUpInstanceUpdate=function(){var e=this;this._instanceUpdateSub.unsubscribe(),this._instanceUpdateSub=null!=this._instance?this._instance.updatedEvt.subscribe((function(){if(e._changeDetectorRef)try{e._changeDetectorRef.detectChanges()}catch(e){}})):r.Subscription.EMPTY,this._changeDetectorRef.detectChanges()},e}();me.decorators=[{type:n.Directive}],me.ctorParameters=function(){return[{type:n.ChangeDetectorRef},{type:he},{type:void 0}]};
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     *
     */
var ye=function(){function e(){}return e.prototype.transform=function(e){return null==e?null:"today"===e?new Date:e},e}();ye.decorators=[{type:n.Pipe,args:[{name:"ajfDateValue"}]}];
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     *
     */
var Ie=function(n,t,r){if(null==n)return"";var o=n.stringIdentifier||[];if(0===o.length)return"";var i=le(n.nodes).filter((function(e){return S(e)&&F(e)}));return i.length>0&&(t=Object.assign({},t),i.forEach((function(n){var o=t[n.name];if(null!=o)if(n.fieldType===e.AjfFieldType.SingleChoice){var i=n.choicesOrigin.choices.find((function(e){return e.value===o}));if(null==i)return;t[n.name]=i.label}else if(n.fieldType===e.AjfFieldType.MultipleChoice&&Array.isArray(o)&&o.length>0){var a=c.buildStringIdentifierOpts(r),s=n.choicesOrigin.choices.filter((function(e){return o.indexOf(e.value)>-1}));t[n.name]=s.map((function(e){return e.label})).join(a.valuesDivider)}}))),c.buildStringIdentifier(o,t,r)},Ee=function(){function e(){}return e.prototype.transform=function(e,n,t){return Ie(e,n,t)},e}();
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */function ln(n){return Object.assign(Object.assign(Object.assign({},an(n)),sn(n)),{nodeType:e.AjfNodeType.AjfNodeGroup})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */function un(n){return Object.assign(Object.assign(Object.assign({},an(n)),sn(n)),{nodeType:e.AjfNodeType.AjfRepeatingSlide})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     *
     */
function yn(e){return Object.assign(Object.assign({},rn(Object.assign(Object.assign({},e),{type:"fixed"}))),{type:"fixed"})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.createChoicesFunctionOrigin=function vn(e){return Object.assign(Object.assign({},e),{type:"function",label:e.label||"",choices:e.choices||[]})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.createNode=k,e.createNodeInstance=Y,e.createValidation=ie,e.createValidationGroup=X,e.createWarning=ae,e.createWarningGroup=ee,e.fieldIconName=Ce,e.flattenNodes=le,e.getTypeName=
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.notEmptyWarning=function On(){return ae({condition:"notEmpty($value)",warningMessage:"Value must not be empty"})},e.ɵ0=fe,e.ɵgc_ajf_src_core_forms_forms_a=ln,e.ɵgc_ajf_src_core_forms_forms_b=un,e.ɵgc_ajf_src_core_forms_forms_c=cn,e.ɵgc_ajf_src_core_forms_forms_d=J,Object.defineProperty(e,"__esModule",{value:!0})}));