...
/**
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */var y=function(){function e(){}return e.fromJson=function(e){return m(e)},e}(),v=(o||r)("ajf:models:validated-property"),h=i||a,g={addDays:n.addDays,addMonths:n.addMonths,addYears:n.addYears,endOfISOWeek:n.endOfISOWeek,format:n.format,getDay:n.getDay,parse:n.parseISO,startOfMonth:n.startOfMonth,startOfISOWeek:n.startOfISOWeek};
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */var Y=function(){function e(){}return e.UTIL_FUNCTIONS="",e.utils={digitCount:{fn:b},decimalCount:{fn:N},isInt:{fn:O},notEmpty:{fn:_},valueInChoice:{fn:j},scanGroupField:{fn:x},sum:{fn:S},dateOperations:{fn:A},round:{fn:w},extractArray:{fn:I},extractSum:{fn:P},extractArraySum:{fn:C},drawThreshold:{fn:M},extractDates:{fn:k},lastProperty:{fn:F},sumLastProperties:{fn:D},calculateTrendProperty:{fn:E},calculateTrendByProperties:{fn:T},calculateAvgProperty:{fn:W},calculateAvgPropertyArray:{fn:U},alert:{fn:z},formatNumber:{fn:q},formatDate:{fn:L},isoMonth:{fn:$},getCoordinate:{fn:J},Math:{fn:Math},parseInt:{fn:parseInt},parseFloat:{fn:parseFloat},parseDate:{fn:g.parse},Date:{fn:Date}},e}(),B=(u||t).tokenize,G={};
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */,e.notEmpty=_,e.round=w,e.scanGroupField=x,e.sum=S,e.sumLastProperties=D,e.validateExpression=function re(e,r){r===K?console.log("cache hit"):(K=r,Q=R(r));var t=Q;try{var n=new Function(""+t+e);return v("validating formula %s using context %j",e,t),n(),v("formula %s validated",e),n=null,!0}catch(r){return v("formula %s not validated: error %j",e,r),!1}},e.valueInChoice=j,Object.defineProperty(e,"__esModule",{value:!0})}));