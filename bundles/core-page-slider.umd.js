...
(function (global, factory) {
    ...
    var AjfPageSliderItem = /** @class */ (function () {
        ...
        function AjfPageSliderItem(_el, _renderer) {
            ...
            this._resizeSub = this._resizeEvent.pipe(operators.debounceTime(300)).subscribe((/**
             * @return {?}
             */
        ...
        AjfPageSliderItem.decorators = [
            { type: core.Component, args: [{selector: 'ajf-page-slider-item',
    ...
    var AjfPageSlider = /** @class */ (function () {
        function AjfPageSlider(_animationBuilder, _cdr, _renderer) {
            ...
            this._mouseWheelSub = this._mouseWheelEvt.pipe(operators.map((/**
             * @param {?} evt
             * @return {?}
             */
            function (evt) {
            ...
            function (r) { return r != null
                ...
                && ((r.evt.dir === 'x' && _this.orientation === 'horizontal')
                    || (r.evt.dir === 'y' && _this.orientation === 'vertical')); })), operators.map((/**
             * @param {?} r
             * @return {?}
             */
            function (r) { return (/** @type {?} */ (r)).evt.amount; })), operators.scan((/**
             * @param {?} acc
             * @param {?} val
             * @return {?}
             */
             ...
             * @return {?}
             */
            function (val) { return !_this._animating && Math.abs(val) > 150; })), operators.throttleTime(1500)).subscribe((/**
             * @param {?} val
             * @return {?}
             */
            function (val) {
        ...
        Object.defineProperty(AjfPageSlider.prototype, "hideNavigationButtons", {
             ...
             */
            function (hnb) {
                this._hideNavigationButtons = utils.coerceBooleanProperty(hnb);
                this._cdr.markForCheck();
            },
            enumerable: true,
            configurable: true
