...
/**
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */function G(e){var A="function"==typeof Symbol&&Symbol.iterator,t=A&&e[A],n=0;if(t)return t.call(e);if(e&&"number"==typeof e.length)return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(A?"Object is not iterable.":"Symbol.iterator is not defined.")}function R(e,A){var t="function"==typeof Symbol&&e[Symbol.iterator];if(!t)return e;var n,r,f=t.call(e),a=[];try{for(;(void 0===A||A-- >0)&&!(n=f.next()).done;)a.push(n.value)}catch(e){r={error:e}}finally{try{n&&!n.done&&(t=f.return)&&t.call(f)}finally{if(r)throw r.error}}return a}function q(e,A){for(var t=0,n=A.length,r=e.length;t<n;t++,r++)e[r]=A[t];return e}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
