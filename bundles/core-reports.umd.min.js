...
/**
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */M.decorators=[{type:A.Directive}],M.ctorParameters=function(){return[{type:A.ComponentFactoryResolver},{type:A.Renderer2}]},M.propDecorators={widgetHost:[{type:A.ViewChild,args:[z,{static:!0}]}],instance:[{type:A.Input}]};
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
var E={},W=function(){function e(){this.componentsMap=E}return e.prototype.registerCustomWidget=function(e){var A=e.widgetType,t=e.component;if(A<100)throw new Error("Invalid custom widget type, it must be greater than 100");if(null==t)throw new Error("Invalid custom widget component");this.componentsMap[A]=e},e}();
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
