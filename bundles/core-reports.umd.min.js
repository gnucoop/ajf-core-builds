!function(e,A){"object"==typeof exports&&"undefined"!=typeof module?A(exports,require("@angular/core"),require("@ajf/core/common"),require("@angular/common"),require("date-fns"),require("xlsx"),require("@ajf/core/models"),require("@ajf/core/utils"),require("@ajf/core/image"),require("pdfmake/build/pdfmake")):"function"==typeof define&&define.amd?define("@ajf/core/reports",["exports","@angular/core","@ajf/core/common","@angular/common","date-fns","xlsx","@ajf/core/models","@ajf/core/utils","@ajf/core/image","pdfmake/build/pdfmake"],A):A(((e=e||self).ajf=e.ajf||{},e.ajf.core=e.ajf.core||{},e.ajf.core.reports={}),e.ng.core,e.ajf.core.common,e.ng.common,e.dateFns,e.xlsx,e.ajf.core.models,e.ajf.core.utils,e.ajf.core.image,e.pdfmake.build.pdfmake)}(this,(function(e,A,t,n,r,f,a,o,i,u){"use strict";
/**
     * @license
     ...
     *
     */var d,l=function(){function e(e,A){this._cdr=e,this.el=A}return Object.defineProperty(e.prototype,"instance",{get:function(){return this._instance},set:function(e){this._instance!==e&&(this._instance=e,this._cdr.detectChanges())},enumerable:!1,configurable:!0}),e}();
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     *
     */
function s(A){switch(A){case e.AjfChartType.Line:return"line";case e.AjfChartType.Bar:return"bar";case e.AjfChartType.HorizontalBar:return"horizontalBar";case e.AjfChartType.Radar:return"radar";case e.AjfChartType.Scatter:return"scatter";case e.AjfChartType.Doughnut:return"doughnut";case e.AjfChartType.Pie:return"pie";case e.AjfChartType.PolarArea:return"polarArea";case e.AjfChartType.Bubble:return"bubble";default:return"line"}}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */(d=e.AjfChartType||(e.AjfChartType={}))[d.Line=0]="Line",d[d.Bar=1]="Bar",d[d.HorizontalBar=2]="HorizontalBar",d[d.Radar=3]="Radar",d[d.Scatter=4]="Scatter",d[d.Doughnut=5]="Doughnut",d[d.Pie=6]="Pie",d[d.PolarArea=7]="PolarArea",d[d.Bubble=8]="Bubble",d[d.LENGTH=9]="LENGTH";var v,j,m=function(){function e(){}return e.prototype.transform=function(e,A){return A>=0&&A<e.content.length?e.content[A]:null},e}();m.decorators=[{type:A.Pipe,args:[{name:"ajfGetColumnContent"}]}],(
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
v=e.AjfAggregationType||(e.AjfAggregationType={}))[v.None=0]="None",v[v.Sum=1]="Sum",v[v.Average=2]="Average",v[v.WeightedAverage=3]="WeightedAverage",v[v.LENGTH=4]="LENGTH",(
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
j=e.AjfWidgetType||(e.AjfWidgetType={}))[j.Layout=0]="Layout",j[j.PageBreak=1]="PageBreak",j[j.Image=2]="Image",j[j.Text=3]="Text",j[j.Chart=4]="Chart",j[j.Table=5]="Table",j[j.Map=6]="Map",j[j.Column=7]="Column",j[j.Formula=8]="Formula",j[j.ImageContainer=9]="ImageContainer",j[j.DynamicTable=10]="DynamicTable",j[j.LENGTH=11]="LENGTH";
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
var c=function(){function e(e){this._cdr=e}return Object.defineProperty(e.prototype,"instance",{get:function(){return this._instance},set:function(e){this._instance=e,this._report=null!=e?e.report:null,this._cdr.markForCheck()},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"report",{get:function(){return this._report},enumerable:!1,configurable:!0}),e}();c.decorators=[{type:A.Directive}],c.ctorParameters=function(){return[{type:A.ChangeDetectorRef}]},c.propDecorators={instance:[{type:A.Input}]};
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
var b=function(){function e(){}return e.prototype.transform=function(e,A,n){return function(e,A,n){if(null==e)return"";var r=e.stringIdentifier||[];return 0===r.length?"":t.buildStringIdentifier(r,A,n)}(e,A,n)},e}();
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */b.decorators=[{type:A.Pipe,args:[{name:"ajfReportStringIdentifier"}]}];
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
var z,p,h=function(){function A(){this.overlay=!0,this.enable=!1}return A.prototype.exportCsv=function(){this.export("csv")},A.prototype.exportXlsx=function(){this.export("xlsx")},A.prototype.export=function(e){var A=this._buildTitle(this.widgetType),t={};t[A]=f.utils.aoa_to_sheet(this._buildXlsxData()),f.writeFile({Sheets:t,SheetNames:[A]},A+"."+e,{bookType:e,type:"array"})},A.prototype._buildXlsxData=function(){var A=[],t=[];switch(this.widgetType){default:case e.AjfWidgetType.Chart:this.data=this.data;var n=this.data.datasets||[];t=["name"].concat(this.data.labels),A.push(t);for(var r=0;r<n.length;r++){var f=[],a=n[r].data||[];f.push(n[r].label);for(var o=0;o<a.length;o++)f.push(a[o]);A.push(f)}break;case e.AjfWidgetType.Table:this.data=this.data,this.data.forEach((function(e,n){var r=[];0===n?(e.forEach((function(e){if(t.push(e.value.changingThisBreaksApplicationSecurity),e.colspan&&e.colspan>1)for(var A=1;A<e.colspan;A++)t.push(" ")})),A.push(t)):(e.forEach((function(e){r.push(e.value.changingThisBreaksApplicationSecurity)})),A.push(r))}))}return A},A.prototype._buildTitle=function(A){return e.AjfWidgetType[A]+" "+r.format(new Date,"yyyy-MM-dd")},A}();
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
function g(A){return Object.assign(Object.assign({},A),{aggregation:A.aggregation||e.AjfAggregationType.None})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */h.decorators=[{type:A.Component,args:[{selector:"ajf-widget-export",template:'<div class="ajf-widget-wrapper">\n  <ng-content></ng-content>\n  <div *ngIf="enable" class="ajf-export-menu" [class.ajf-export-menu-overlay]="overlay">\n      <button (click)="export(\'csv\')">CSV</button>\n      <button (click)="export(\'xlsx\')">XLSX</button>\n  </div>\n</div>\n',encapsulation:A.ViewEncapsulation.None,changeDetection:A.ChangeDetectionStrategy.OnPush,styles:["ajf-widget-export{width:100%;height:inherit}ajf-widget-export .ajf-widget-wrapper{position:relative;height:inherit}ajf-widget-export .ajf-export-menu{position:absolute;right:0;top:0}ajf-widget-export .ajf-export-menu.ajf-export-menu-overlay{display:none}ajf-widget-export .ajf-export-menu button{margin:.5em;border:none;color:#fff;background-color:#4a403f;padding:7.5px 16px;text-align:center;text-decoration:none;display:inline-block;font-size:16px;cursor:pointer}ajf-widget-export .ajf-widget-wrapper:hover .ajf-export-menu-overlay{display:block}\n"]}]}],h.ctorParameters=function(){return[]},h.propDecorators={widgetType:[{type:A.Input}],data:[{type:A.Input}],overlay:[{type:A.Input}],enable:[{type:A.Input}]},(z=function z(e){this.viewContainerRef=e}).decorators=[{type:A.Directive,args:[{selector:"[ajf-widget-host]"}]}],z.ctorParameters=function(){return[{type:A.ViewContainerRef}]},(p=function p(){}).decorators=[{type:A.NgModule,args:[{declarations:[m,b,z,h],imports:[n.CommonModule],exports:[m,b,z,h]}]}];var T=function(){function e(){}return e.fromJson=function(e){if(null==e.aggregation)throw new Error("Malformed aggregation");return g(Object.assign(Object.assign({},e),{aggregation:e.aggregation}))},e}(),Z=function(){function A(){}return A.fromJson=function(A){if(null==A.formula||null==A.aggregation||null==A.label)throw new Error("Malformed dataset");return A.formula=A.formula instanceof Array?A.formula=A.formula.map((function(e){return a.AjfFormulaSerializer.fromJson(e)})):a.AjfFormulaSerializer.fromJson(A.formula),A.aggregation=T.fromJson(A.aggregation),
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
function t(A){return Object.assign(Object.assign({},A),{aggregation:A.aggregation||g({aggregation:e.AjfAggregationType.None})})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     *
     */
function O(e){return Object.assign(Object.assign({},e),{styles:e.styles||{},visibility:e.visibility||a.alwaysCondition()})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */E.decorators=[{type:A.Directive}],E.ctorParameters=function(){return[{type:A.ComponentFactoryResolver},{type:A.Renderer2}]},E.propDecorators={widgetHost:[{type:A.ViewChild,args:[z,{static:!0}]}],instance:[{type:A.Input}]};
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
var M={},W=function(){function e(){this.componentsMap=M}return e.prototype.registerCustomWidget=function(e){var A=e.widgetType,t=e.component;if(A<100)throw new Error("Invalid custom widget type, it must be greater than 100");if(null==t)throw new Error("Invalid custom widget component");this.componentsMap[A]=e},e}();
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */function I(e){var A="function"==typeof Symbol&&Symbol.iterator,t=A&&e[A],n=0;if(t)return t.call(e);if(e&&"number"==typeof e.length)return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(A?"Object is not iterable.":"Symbol.iterator is not defined.")}function G(e,A){var t="function"==typeof Symbol&&e[Symbol.iterator];if(!t)return e;var n,r,f=t.call(e),a=[];try{for(;(void 0===A||A-- >0)&&!(n=f.next()).done;)a.push(n.value)}catch(e){r={error:e}}finally{try{n&&!n.done&&(t=f.return)&&t.call(f)}finally{if(r)throw r.error}}return a}function R(e,A){for(var t=0,n=A.length,r=e.length;t<n;t++,r++)e[r]=A[t];return e}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */function Y(e,A,t){return{widget:e,widgetType:e.widgetType,visible:a.evaluateExpression(e.visibility.condition,A),styles:e.styles||{}}}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */function Q(e,A,t){var n=e.formula;if('"'===n.substr(0,1)||"'"===n.substr(0,1)){var r=n.slice(1,-1),f=null!=r&&"string"==typeof r&&r.trim().length>0?t.instant(r):r;r.length>0&&(n='"'+f+'"')}else n=null!=n&&"string"==typeof n&&n.trim().length>0?t.instant(n):n;return a.evaluateExpression(n,A)}function H(A,t,n){var r=Y(A,t);if(A.widgetType===e.AjfWidgetType.Column||A.widgetType===e.AjfWidgetType.Layout){var f=A,i=r,u=[];f.content.forEach((function(e){if(null!=f.repetitions){if(i.repetitions=a.evaluateExpression(f.repetitions.formula,t),"number"==typeof i.repetitions&&i.repetitions>0)for(var A=0;A<i.repetitions;A++)u.push(H(e,Object.assign(Object.assign({},t),{$repetition:A}),n))}else u.push(H(e,t,n));i.content=u}))}else if(A.widgetType===e.AjfWidgetType.Chart){var d=A,l=r,v=(d.labels instanceof Array?d.labels:[d.labels]).map((function(e){var A=a.evaluateExpression(e.formula,t);try{A=A instanceof Array?A.map((function(e){return null!=e&&"string"==typeof e&&e.trim().length>0?n.instant(e):e})):null!=A&&"string"==typeof A&&A.trim().length>0?n.instant(A):A}catch(e){}return A}));if(l.labels=d.labels instanceof Array?v:v[0],l.datasets=d.dataset.map((function(e){var A=Object.assign(Object.assign({},e.options||{}),{data:q(e.aggregation,e.formula,t)});if(null!=e.chartType){var r=s(e.chartType);A=Object.assign(Object.assign({},A),{chartType:r,type:r})}return null!=e.options&&(A=Object.assign(Object.assign({},A),{options:e.options})),null!=e.label&&(A=Object.assign(Object.assign({},A),{label:e.label.trim().length>0?n.instant(e.label):e.label})),null!=e.datalabels&&(A.datalabels=o.deepCopy(e.datalabels)),A})),l.data={labels:l.labels,datasets:l.datasets},l.chartType=s(d.type||d.chartType),l.exportable=!(!d.exportable||!0!==d.exportable&&"true"!==d.exportable),null!=d.options&&null!=d.options.plugins){var j=d.options.plugins;Object.keys(j).forEach((function(e){var A=j[e];Object.keys(A).forEach((function(e){var n=A[e];"string"!=typeof n&&null!=n&&null!=n.formula&&(A[e]=a.evaluateExpression(n.formula,t))}))}))}}else if(A.widgetType===e.AjfWidgetType.Table){var m=A,c=r;c.dataset=m.dataset.map((function(e){return e.map((function(e){return e.formula instanceof Array?e.formula.map((function(e){return Q(e,t,n)})):Q(e.formula,t,n)}))})),c.exportable=!(!m.exportable||!0!==m.exportable&&"true"!==m.exportable),c.data=(m.dataset||[]).map((function(e){return e.map((function(e){var A="";try{A=e.formula instanceof Array?e.formula.map((function(e){return Q(e,t,n)})):Q(e.formula,t,n)}catch(e){}return{value:A,style:Object.assign(Object.assign({},m.cellStyles),e.style),rowspan:e.rowspan,colspan:e.colspan}}))}))}else if(A.widgetType===e.AjfWidgetType.DynamicTable){var b=A,z=r;z.dataset=b.dataset.map((function(e){return e.formula instanceof Array?e.formula.map((function(e){return Q(e,t,n)})):Q(e.formula,t,n)})),z.exportable=!(!b.exportable||!0!==b.exportable&&"true"!==b.exportable);var p=a.evaluateExpression(b.rowDefinition.formula,t)||[];p=(p||[]).map((function(e){return e.map((function(e){var A=e.value;try{A=A instanceof Array?A.map((function(e){return null!=e&&"string"==typeof e&&e.trim().length>0?n.instant(e):e})):null!=A&&"string"==typeof A&&A.trim().length>0?n.instant(A):A}catch(e){}return Object.assign(Object.assign({},e),{value:A})}))}));var h=(b.dataset||[]).map((function(e){var A="";try{A=e.formula instanceof Array?e.formula.map((function(e){return Q(e,t,n)})):Q(e.formula,t,n)}catch(e){}return{value:A,style:Object.assign(Object.assign({},b.cellStyles),e.style),rowspan:e.rowspan,colspan:e.colspan}}));z.data=R([R([],G(h))],G(p))}else if(A.widgetType===e.AjfWidgetType.Image){var g=A,T=r;g.flag&&(T.flag=a.evaluateExpression(g.flag.formula,t)),g.icon&&(T.icon=a.evaluateExpression(g.icon.formula,t)),g.url&&(T.url=a.evaluateExpression(g.url.formula,t))}else if(A.widgetType===e.AjfWidgetType.ImageContainer){var Z=A,O=r;Z.flags&&(O.flags=Z.flags instanceof Array?Z.flags.map((function(e){return a.evaluateExpression(e.formula,t)})):a.evaluateExpression(Z.flags.formula,t)),Z.icons&&(O.icons=Z.icons instanceof Array?Z.icons.map((function(e){return a.evaluateExpression(e.formula,t)})):a.evaluateExpression(Z.icons.formula,t)),Z.urls&&(O.urls=Z.urls instanceof Array?Z.urls.map((function(e){return a.evaluateExpression(e.formula,t)})):a.evaluateExpression(Z.urls.formula,t))}else if(A.widgetType===e.AjfWidgetType.Text){for(var x=r,P=/\[{2}(.+?)\]{2}/g,y=[],E=void 0,W=A.htmlText;E=P.exec(W);){var I=E.index,N=E[0].length,V=a.createFormula({formula:E[1]});y.push({idx:I,len:N,formula:V})}y.reverse().forEach((function(e){var A;try{A=a.evaluateExpression(e.formula.formula,t)}catch(e){A=""}W=""+W.substr(0,e.idx)+A+W.substr(e.idx+e.len)})),x.htmlText=null!=W&&W.length>0?n.instant(W):W}else if(A.widgetType===e.AjfWidgetType.Formula)r.formula=a.evaluateExpression(A.formula.formula,t);else if(A.widgetType===e.AjfWidgetType.Map)r.coordinate=a.evaluateExpression(A.coordinate.formula,t);else if(A.widgetType>100){var X=null!=M[A.widgetType]?M[A.widgetType].initInstance:null;if(null!=X)return X(r,t,n)}return r}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */function N(e,A,t){var n=e.content.map((function(e){return H(e,A,t)}));return{container:e,content:n,styles:e.styles}}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     *
     */
e.AjfAggregationSerializer=T,e.AjfBaseWidgetComponent=l,e.AjfDatasetSerializer=Z,e.AjfGetColumnContentPipe=m,e.AjfReportContainerSerializer=P,e.AjfReportRenderer=c,e.AjfReportSerializer=y,e.AjfReportStringIdentifierPipe=b,e.AjfReportWidget=E,e.AjfReportsModule=p,e.AjfWidgetExport=h,e.AjfWidgetHost=z,e.AjfWidgetSerializer=x,e.AjfWidgetService=W,e.chartToChartJsType=s,e.createAggregation=g,e.createReportInstance=function D(e,A,t){return(e.variables||[]).forEach((function(e){A[e.name]=a.evaluateExpression(e.formula.formula,A)})),{report:e,header:e.header?N(e.header,A,t):void 0,content:e.content?N(e.content,A,t):void 0,footer:e.footer?N(e.footer,A,t):void 0,styles:e.styles||{}}},e.createReportPdf=C,e.createWidget=O,e.createWidgetInstance=Y,e.openReportPdf=function L(e,A){C(e,A).then((function(e){e.open()}))},e.widgetToWidgetInstance=H,Object.defineProperty(e,"__esModule",{value:!0})}));