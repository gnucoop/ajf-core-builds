...
/**
     ...
     *
     */
function W(e){return Object.assign(Object.assign({},e),{styles:e.styles||{},visibility:e.visibility||o.alwaysCondition()})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */function N(e,A,t){return{widget:e,widgetType:e.widgetType,visible:o.evaluateExpression(e.visibility.condition,A),styles:e.styles||{}}}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */function X(e,A,t){var n=e.formula;if('"'===n.substr(0,1)||"'"===n.substr(0,1)){var r=n.slice(1,-1),f=null!=r&&"string"==typeof r&&r.trim().length>0?t.instant(r):r;r.length>0&&(n='"'+f+'"')}else n=null!=n&&"string"==typeof n&&n.trim().length>0?t.instant(n):n;return o.evaluateExpression(n,A)}function V(A,t,n){var r=N(A,t);if(A.widgetType===e.AjfWidgetType.Column||A.widgetType===e.AjfWidgetType.Layout){var f=A,a=r,u=[];f.content.forEach((function(e){if(null!=f.repetitions){if(a.repetitions=o.evaluateExpression(f.repetitions.formula,t),"number"==typeof a.repetitions&&a.repetitions>0)for(var A=0;A<a.repetitions;A++)u.push(V(e,Object.assign(Object.assign({},t),{$repetition:A}),n))}else u.push(V(e,t,n));a.content=u}))}else if(A.widgetType===e.AjfWidgetType.Chart){var d=A,l=r,s=(d.labels instanceof Array?d.labels:[d.labels]).map((function(e){var A=o.evaluateExpression(e.formula,t);try{A=A instanceof Array?A.map((function(e){return null!=e&&"string"==typeof e&&e.trim().length>0?n.instant(e):e})):null!=A&&"string"==typeof A&&A.trim().length>0?n.instant(A):A}catch(e){}return A}));if(l.labels=d.labels instanceof Array?s:s[0],l.datasets=d.dataset.map((function(e){var A=Object.assign(Object.assign({},e.options||{}),{data:H(e.aggregation,e.formula,t)});if(null!=e.chartType){var r=m(e.chartType);A=Object.assign(Object.assign({},A),{chartType:r,type:r})}return null!=e.options&&(A=Object.assign(Object.assign({},A),{options:e.options})),null!=e.label&&(A=Object.assign(Object.assign({},A),{label:e.label.trim().length>0?n.instant(e.label):e.label})),null!=e.datalabels&&(A.datalabels=i.deepCopy(e.datalabels)),A})),l.data={labels:l.labels,datasets:l.datasets},l.chartType=m(d.type||d.chartType),l.exportable=!(!d.exportable||!0!==d.exportable&&"true"!==d.exportable),null!=d.options&&null!=d.options.plugins){var v=d.options.plugins;Object.keys(v).forEach((function(e){var A=v[e];Object.keys(A).forEach((function(e){var n=A[e];"string"!=typeof n&&null!=n&&null!=n.formula&&(A[e]=o.evaluateExpression(n.formula,t))}))}))}}else if(A.widgetType===e.AjfWidgetType.Table){var j=A,c=r;c.dataset=j.dataset.map((function(e){return e.map((function(e){return e.formula instanceof Array?e.formula.map((function(e){return X(e,t,n)})):X(e.formula,t,n)}))})),c.exportable=!(!j.exportable||!0!==j.exportable&&"true"!==j.exportable),c.data=(j.dataset||[]).map((function(e){return e.map((function(e){var A="";try{A=e.formula instanceof Array?e.formula.map((function(e){return X(e,t,n)})):X(e.formula,t,n)}catch(e){}return{value:A,style:Object.assign(Object.assign({},j.cellStyles),e.style),rowspan:e.rowspan,colspan:e.colspan}}))}))}else if(A.widgetType===e.AjfWidgetType.DynamicTable){var b=A,z=r;z.dataset=b.dataset.map((function(e){return e.formula instanceof Array?e.formula.map((function(e){return X(e,t,n)})):X(e.formula,t,n)})),z.exportable=!(!b.exportable||!0!==b.exportable&&"true"!==b.exportable);var p=o.evaluateExpression(b.rowDefinition.formula,t)||[];p=(p||[]).map((function(e){return e.map((function(e){var A=e.value;try{A=A instanceof Array?A.map((function(e){return null!=e&&"string"==typeof e&&e.trim().length>0?n.instant(e):e})):null!=A&&"string"==typeof A&&A.trim().length>0?n.instant(A):A}catch(e){}return Object.assign(Object.assign({},e),{value:A})}))}));var h=(b.dataset||[]).map((function(e){var A="";try{A=e.formula instanceof Array?e.formula.map((function(e){return X(e,t,n)})):X(e.formula,t,n)}catch(e){}return{value:A,style:Object.assign(Object.assign({},b.cellStyles),e.style),rowspan:e.rowspan,colspan:e.colspan}}));z.data=Z([Z(h)],p)}else if(A.widgetType===e.AjfWidgetType.Image){var g=A,T=r;g.flag&&(T.flag=o.evaluateExpression(g.flag.formula,t)),g.icon&&(T.icon=o.evaluateExpression(g.icon.formula,t)),g.url&&(T.url=o.evaluateExpression(g.url.formula,t))}else if(A.widgetType===e.AjfWidgetType.ImageContainer){var O=A,x=r;O.flags&&(x.flags=O.flags instanceof Array?O.flags.map((function(e){return o.evaluateExpression(e.formula,t)})):o.evaluateExpression(O.flags.formula,t)),O.icons&&(x.icons=O.icons instanceof Array?O.icons.map((function(e){return o.evaluateExpression(e.formula,t)})):o.evaluateExpression(O.icons.formula,t)),O.urls&&(x.urls=O.urls instanceof Array?O.urls.map((function(e){return o.evaluateExpression(e.formula,t)})):o.evaluateExpression(O.urls.formula,t))}else if(A.widgetType===e.AjfWidgetType.Text){for(var y=r,P=/\[{2}(.+?)\]{2}/g,E=[],M=void 0,W=A.htmlText;M=P.exec(W);){var I=M.index,G=M[0].length,R=o.createFormula({formula:M[1]});E.push({idx:I,len:G,formula:R})}E.reverse().forEach((function(e){var A;try{A=o.evaluateExpression(e.formula.formula,t)}catch(e){A=""}W=""+W.substr(0,e.idx)+A+W.substr(e.idx+e.len)})),y.htmlText=null!=W&&W.length>0?n.instant(W):W}else if(A.widgetType===e.AjfWidgetType.Formula)r.formula=o.evaluateExpression(A.formula.formula,t);else if(A.widgetType===e.AjfWidgetType.Map)r.coordinate=o.evaluateExpression(A.coordinate.formula,t);else if(A.widgetType>100){var q=null!=Y[A.widgetType]?Y[A.widgetType].initInstance:null;if(null!=q)return q(r,t,n)}return r}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
