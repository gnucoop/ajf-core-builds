!function(e,A){"object"==typeof exports&&"undefined"!=typeof module?A(exports,require("@angular/core"),require("@ajf/core/common"),require("@angular/common"),require("date-fns"),require("file-saver"),require("xlsx"),require("@ajf/core/models"),require("@ajf/core/utils"),require("@ajf/core/image"),require("pdfmake/build/pdfmake")):"function"==typeof define&&define.amd?define("@ajf/core/reports",["exports","@angular/core","@ajf/core/common","@angular/common","date-fns","file-saver","xlsx","@ajf/core/models","@ajf/core/utils","@ajf/core/image","pdfmake/build/pdfmake"],A):A(((e=e||self).ajf=e.ajf||{},e.ajf.core=e.ajf.core||{},e.ajf.core.reports={}),e.ng.core,e.ajf.core.common,e.ng.common,e.dateFns,e["file-saver"],e.xlsx,e.ajf.core.models,e.ajf.core.utils,e.ajf.core.image,e.pdfmake.build.pdfmake)}(this,(function(e,A,t,n,r,f,a,i,o,u,d){"use strict";var l,s="default"in f?f.default:f,v="default"in a?a.default:a,j=function(){function e(e,A){this._cdr=e,this.el=A}return Object.defineProperty(e.prototype,"instance",{get:function(){return this._instance},set:function(e){this._instance!==e&&(this._instance=e,this._cdr.detectChanges())},enumerable:!1,configurable:!0}),e}();
/**
     * @license
     ...
     *
     */
function m(A){switch(A){case e.AjfChartType.Line:return"line";case e.AjfChartType.Bar:return"bar";case e.AjfChartType.HorizontalBar:return"horizontalBar";case e.AjfChartType.Radar:return"radar";case e.AjfChartType.Scatter:return"scatter";case e.AjfChartType.Doughnut:return"doughnut";case e.AjfChartType.Pie:return"pie";case e.AjfChartType.PolarArea:return"polarArea";case e.AjfChartType.Bubble:return"bubble";default:return"line"}}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     *
     */
l=e.AjfChartType||(e.AjfChartType={}))[l.Line=0]="Line",l[l.Bar=1]="Bar",l[l.HorizontalBar=2]="HorizontalBar",l[l.Radar=3]="Radar",l[l.Scatter=4]="Scatter",l[l.Doughnut=5]="Doughnut",l[l.Pie=6]="Pie",l[l.PolarArea=7]="PolarArea",l[l.Bubble=8]="Bubble",l[l.LENGTH=9]="LENGTH";var c,b,z=function(){function e(){}return e.prototype.transform=function(e,A){return A>=0&&A<e.content.length?e.content[A]:null},e}();z.decorators=[{type:A.Pipe,args:[{name:"ajfGetColumnContent"}]}],(
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
c=e.AjfAggregationType||(e.AjfAggregationType={}))[c.None=0]="None",c[c.Sum=1]="Sum",c[c.Average=2]="Average",c[c.WeightedAverage=3]="WeightedAverage",c[c.LENGTH=4]="LENGTH",(
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
b=e.AjfWidgetType||(e.AjfWidgetType={}))[b.Layout=0]="Layout",b[b.PageBreak=1]="PageBreak",b[b.Image=2]="Image",b[b.Text=3]="Text",b[b.Chart=4]="Chart",b[b.Table=5]="Table",b[b.Map=6]="Map",b[b.Column=7]="Column",b[b.Formula=8]="Formula",b[b.ImageContainer=9]="ImageContainer",b[b.DynamicTable=10]="DynamicTable",b[b.LENGTH=11]="LENGTH";
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
var p=function(){function e(e){this._cdr=e}return Object.defineProperty(e.prototype,"instance",{get:function(){return this._instance},set:function(e){this._instance=e,this._report=null!=e?e.report:null,this._cdr.markForCheck()},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,"report",{get:function(){return this._report},enumerable:!1,configurable:!0}),e}();p.decorators=[{type:A.Directive}],p.ctorParameters=function(){return[{type:A.ChangeDetectorRef}]},p.propDecorators={instance:[{type:A.Input}]};
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
var h=function(){function e(){}return e.prototype.transform=function(e,A,n){return function(e,A,n){if(null==e)return"";var r=e.stringIdentifier||[];return 0===r.length?"":t.buildStringIdentifier(r,A,n)}(e,A,n)},e}();
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */function g(e){var A="function"==typeof Symbol&&Symbol.iterator,t=A&&e[A],n=0;if(t)return t.call(e);if(e&&"number"==typeof e.length)return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(A?"Object is not iterable.":"Symbol.iterator is not defined.")}function T(e,A){var t="function"==typeof Symbol&&e[Symbol.iterator];if(!t)return e;var n,r,f=t.call(e),a=[];try{for(;(void 0===A||A-- >0)&&!(n=f.next()).done;)a.push(n.value)}catch(e){r={error:e}}finally{try{n&&!n.done&&(t=f.return)&&t.call(f)}finally{if(r)throw r.error}}return a}function Z(){for(var e=[],A=0;A<arguments.length;A++)e=e.concat(T(arguments[A]));return e}h.decorators=[{type:A.Pipe,args:[{name:"ajfReportStringIdentifier"}]}];var O,x,y=function(){function A(){this.overlay=!0,this.enable=!1}return A.prototype.buildCsv=function(){var A,t,n,r,f="";switch(this.widgetType){default:case e.AjfWidgetType.Chart:if(this.data=this.data,null==this.data.datasets||null==this.data.labels)return f;f=","+this.data.labels.toString()+"\n",this.data.datasets.forEach((function(e){f+=e.label+","+(e.data||[]).toString()+"\n"}));break;case e.AjfWidgetType.Table:var a="",i=0;this.data=this.data;try{for(var o=g(this.data),u=o.next();!u.done;u=o.next()){var d=u.value;f+=a;try{for(var l=(n=void 0,g(d)),s=l.next();!s.done;s=l.next()){var v=s.value;null==v.rowspan?(parseInt(v.value,10),f+=v.value+","):(i=v.rowspan,f+=v.value+",",a=",")}}catch(e){n={error:e}}finally{try{s&&!s.done&&(r=l.return)&&r.call(l)}finally{if(n)throw n.error}}","===f[f.length-1]&&(f=f.substring(0,f.length-1)),f+="\n",--i>0&&(f+=","),a=""}}catch(e){A={error:e}}finally{try{u&&!u.done&&(t=o.return)&&t.call(o)}finally{if(A)throw A.error}}}return f},A.prototype.exportCsv=function(){null!=this.widgetType&&null!=this.data&&s(new Blob([this.buildCsv()],{type:"text/csv;charset=utf-8"}),this._buildTitle(this.widgetType)+".csv")},A.prototype.buildXlsx=function(){var A=[],t=[];switch(this.widgetType){default:case e.AjfWidgetType.Chart:this.data=this.data;var n=this.data.datasets||[];t=this.data.labels;for(var r=0;r<n.length;r++){var f={},a=n[r].data||[];f.name=n[r].label;for(var i=0;i<a.length;i++)f[t[i]]=a[i];A.push(f)}break;case e.AjfWidgetType.Table:this.data=this.data,this.data.forEach((function(e,n){var r={};0===n?t=e.map((function(e){return e.value.changingThisBreaksApplicationSecurity})):(e.forEach((function(e,A){r[t[A]]=e.value.changingThisBreaksApplicationSecurity})),A.push(r))}))}return A},A.prototype.exportXlsx=function(){var e=v.utils.json_to_sheet(this.buildXlsx()),A=v.utils.book_new(),t=this._buildTitle(this.widgetType);v.utils.book_append_sheet(A,e,t),v.writeFile(A,t+".xlsx")},A.prototype._buildTitle=function(A){return e.AjfWidgetType[A]+" "+r.format(new Date,"yyyy-MM-dd")},A}();
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
function P(A){return Object.assign(Object.assign({},A),{aggregation:A.aggregation||e.AjfAggregationType.None})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */y.decorators=[{type:A.Component,args:[{selector:"ajf-widget-export",template:'\n    <div class="ajf-widget-wrapper">\n        <ng-content></ng-content>\n        <div  *ngIf="enable" class="ajf-export-menu" [style.display]="!overlay?\'block\':\'none\'">\n            <button (click)="exportCsv()">\n                CSV\n            </button>\n            <button (click)="exportXlsx()" mat-menu-item>\n                XLSX\n            </button>\n        </div>\n    </div>\n    ',encapsulation:A.ViewEncapsulation.None,changeDetection:A.ChangeDetectionStrategy.OnPush,styles:["ajf-widget-export{width:100%;height:inherit}ajf-widget-export .ajf-export-menu{position:absolute;right:0;top:0}ajf-widget-export .ajf-export-menu button{margin:.5em;border:none;color:#fff;background-color:#4a403f;padding:7.5px 16px;text-align:center;text-decoration:none;display:inline-block;font-size:16px;cursor:pointer}ajf-widget-export .ajf-widget-wrapper{position:relative;height:inherit}ajf-widget-export .ajf-widget-wrapper:hover .ajf-export-menu{display:block !important}\n"]}]}],y.ctorParameters=function(){return[]},y.propDecorators={widgetType:[{type:A.Input}],data:[{type:A.Input}],overlay:[{type:A.Input}],enable:[{type:A.Input}]},(O=function O(e){this.viewContainerRef=e}).decorators=[{type:A.Directive,args:[{selector:"[ajf-widget-host]"}]}],O.ctorParameters=function(){return[{type:A.ViewContainerRef}]},(x=function x(){}).decorators=[{type:A.NgModule,args:[{declarations:[z,h,O,y],imports:[n.CommonModule],exports:[z,h,O,y]}]}];var E=function(){function e(){}return e.fromJson=function(e){if(null==e.aggregation)throw new Error("Malformed aggregation");return P(Object.assign(Object.assign({},e),{aggregation:e.aggregation}))},e}(),M=function(){function A(){}return A.fromJson=function(A){if(null==A.formula||null==A.aggregation||null==A.label)throw new Error("Malformed dataset");return A.formula=A.formula instanceof Array?A.formula=A.formula.map((function(e){return i.AjfFormulaSerializer.fromJson(e)})):i.AjfFormulaSerializer.fromJson(A.formula),A.aggregation=E.fromJson(A.aggregation),
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
function t(A){return Object.assign(Object.assign({},A),{aggregation:A.aggregation||P({aggregation:e.AjfAggregationType.None})})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     *
     */
function W(e){return Object.assign(Object.assign({},e),{styles:e.styles||{},visibility:e.visibility||i.alwaysCondition()})}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */var I=function(){function A(){}return A.fromJson=function(t){if(null==t.widgetType)throw new Error("Malformed widget");t.visibility=t.visibility?i.AjfConditionSerializer.fromJson(t.visibility):i.alwaysCondition(),t.styles=t.styles||{};var n=t;if(n.widgetType===e.AjfWidgetType.Layout||n.widgetType===e.AjfWidgetType.Column)return A._widgetWithContentFromJson(n);if(n.widgetType===e.AjfWidgetType.Chart||n.widgetType===e.AjfWidgetType.Table){var r=A._dataWidgetFromJson(n);if(n.widgetType===e.AjfWidgetType.Chart){var f=r;f.labels instanceof Array?f.labels.map((function(e){return i.AjfFormulaSerializer.fromJson(e)})):null!=f.labels&&(f.labels=i.AjfFormulaSerializer.fromJson(f.labels))}return r}return n.widgetType===e.AjfWidgetType.Map&&(n.coordinate=i.AjfFormulaSerializer.fromJson(n.coordinate)),n},A._dataWidgetFromJson=function(A){var t;return t=null==A.dataset?[]:A.dataset.map(A.widgetType===e.AjfWidgetType.Table?function(e){return e.map((function(e){return M.fromJson(e)}))}:function(e){return M.fromJson(e)}),Object.assign(Object.assign({},W(A)),{dataset:t})},A._widgetWithContentFromJson=function(e){var t=(e.content||[]).map((function(e){return A.fromJson(e)}));return Object.assign(Object.assign({},W(e)),{content:t})},A}(),G=function(){function e(){}return e.fromJson=function(e){return e.content=(e.content||[]).map((function(e){return I.fromJson(e)})),Object.assign(Object.assign({},e),{content:e.content,styles:e.styles||{}})},e}(),R=function(){function e(){}return e.fromJson=function(e){return["header","footer","content"].forEach((function(A){e[A]&&(e[A]=G.fromJson(e[A]))})),
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
function A(e){return Object.assign({},e)}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */(e)},e}(),q=function(){function e(e,A){this._cfr=e,this._renderer=A,this._init=!1}return Object.defineProperty(e.prototype,"instance",{get:function(){return this._instance},set:function(e){this._instance!==e&&(this._instance=e,this._init&&this._loadComponent())},enumerable:!1,configurable:!0}),e.prototype.ngOnInit=function(){this._init=!0,this._loadComponent()},e.prototype._loadComponent=function(){var e=this;if(this._init&&null!=this._instance&&null!=this.widgetHost&&this.instance.visible){var A=this.widgetHost.viewContainerRef;A.clear();var t=this.widgetsMap[this._instance.widget.widgetType];if(null!=t){var n=t.component;try{var r=this._cfr.resolveComponentFactory(n),f=A.createComponent(r).instance;Object.keys(this._instance.widget.styles).forEach((function(A){try{e._renderer.setStyle(f.el.nativeElement,A,""+e._instance.widget.styles[A])}catch(e){}})),f.instance=this._instance,t.inputs&&Object.keys(t.inputs).forEach((function(e){e in f&&(f[e]=t.inputs[e])}))}catch(e){}}}},e}();
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */q.decorators=[{type:A.Directive}],q.ctorParameters=function(){return[{type:A.ComponentFactoryResolver},{type:A.Renderer2}]},q.propDecorators={widgetHost:[{type:A.ViewChild,args:[O,{static:!0}]}],instance:[{type:A.Input}]};
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     *
     */
var Y={},Q=function(){function e(){this.componentsMap=Y}return e.prototype.registerCustomWidget=function(e){var A=e.widgetType,t=e.component;if(A<100)throw new Error("Invalid custom widget type, it must be greater than 100");if(null==t)throw new Error("Invalid custom widget component");this.componentsMap[A]=e},e}();
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     *
     */
function H(A,t,n){var r=t.map((function(e){return i.evaluateExpression(e.formula,n)}));switch(A.aggregation){case e.AjfAggregationType.None:if(1!==r.length)throw new Error("Invalid aggregation");return r[0];case e.AjfAggregationType.Sum:return r.map((function(e){return e.reduce((function(e,A){return e+A}),0)}));case e.AjfAggregationType.Average:case e.AjfAggregationType.WeightedAverage:return r.map((function(e){return e.reduce((function(e,A){return e+A}),0)/r.length}));default:return[]}}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */function N(e,A,t){return{widget:e,widgetType:e.widgetType,visible:i.evaluateExpression(e.visibility.condition,A),styles:e.styles||{}}}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */function X(e,A,t){var n=e.formula;if('"'===n.substr(0,1)||"'"===n.substr(0,1)){var r=n.slice(1,-1),f=null!=r&&"string"==typeof r&&r.trim().length>0?t.instant(r):r;r.length>0&&(n='"'+f+'"')}else n=null!=n&&"string"==typeof n&&n.trim().length>0?t.instant(n):n;return i.evaluateExpression(n,A)}function V(A,t,n){var r=N(A,t);if(A.widgetType===e.AjfWidgetType.Column||A.widgetType===e.AjfWidgetType.Layout){var f=A,a=r,u=[];f.content.forEach((function(e){if(null!=f.repetitions){if(a.repetitions=i.evaluateExpression(f.repetitions.formula,t),"number"==typeof a.repetitions&&a.repetitions>0)for(var A=0;A<a.repetitions;A++)u.push(V(e,Object.assign(Object.assign({},t),{$repetition:A}),n))}else u.push(V(e,t,n));a.content=u}))}else if(A.widgetType===e.AjfWidgetType.Chart){var d=A,l=r,s=(d.labels instanceof Array?d.labels:[d.labels]).map((function(e){var A=i.evaluateExpression(e.formula,t);try{A=A instanceof Array?A.map((function(e){return null!=e&&"string"==typeof e&&e.trim().length>0?n.instant(e):e})):null!=A&&"string"==typeof A&&A.trim().length>0?n.instant(A):A}catch(e){}return A}));if(l.labels=d.labels instanceof Array?s:s[0],l.datasets=d.dataset.map((function(e){var A=Object.assign(Object.assign({},e.options||{}),{data:H(e.aggregation,e.formula,t)});if(null!=e.chartType){var r=m(e.chartType);A=Object.assign(Object.assign({},A),{chartType:r,type:r})}return null!=e.options&&(A=Object.assign(Object.assign({},A),{options:e.options})),null!=e.label&&(A=Object.assign(Object.assign({},A),{label:e.label.trim().length>0?n.instant(e.label):e.label})),null!=e.datalabels&&(A.datalabels=o.deepCopy(e.datalabels)),A})),l.data={labels:l.labels,datasets:l.datasets},l.chartType=m(d.type||d.chartType),l.exportable=!(!d.exportable||!0!==d.exportable&&"true"!==d.exportable),null!=d.options&&null!=d.options.plugins){var v=d.options.plugins;Object.keys(v).forEach((function(e){var A=v[e];Object.keys(A).forEach((function(e){var n=A[e];"string"!=typeof n&&null!=n&&null!=n.formula&&(A[e]=i.evaluateExpression(n.formula,t))}))}))}}else if(A.widgetType===e.AjfWidgetType.Table){var j=A,c=r;c.dataset=j.dataset.map((function(e){return e.map((function(e){return e.formula instanceof Array?e.formula.map((function(e){return X(e,t,n)})):X(e.formula,t,n)}))})),c.exportable=!(!j.exportable||!0!==j.exportable&&"true"!==j.exportable),c.data=(j.dataset||[]).map((function(e){return e.map((function(e){var A="";try{A=e.formula instanceof Array?e.formula.map((function(e){return X(e,t,n)})):X(e.formula,t,n)}catch(e){}return{value:A,style:Object.assign(Object.assign({},j.cellStyles),e.style),rowspan:e.rowspan,colspan:e.colspan}}))}))}else if(A.widgetType===e.AjfWidgetType.DynamicTable){var b=A,z=r;z.dataset=b.dataset.map((function(e){return e.formula instanceof Array?e.formula.map((function(e){return X(e,t,n)})):X(e.formula,t,n)})),z.exportable=!(!b.exportable||!0!==b.exportable&&"true"!==b.exportable);var p=i.evaluateExpression(b.rowDefinition.formula,t)||[];p=(p||[]).map((function(e){return e.map((function(e){var A=e.value;try{A=A instanceof Array?A.map((function(e){return null!=e&&"string"==typeof e&&e.trim().length>0?n.instant(e):e})):null!=A&&"string"==typeof A&&A.trim().length>0?n.instant(A):A}catch(e){}return Object.assign(Object.assign({},e),{value:A})}))}));var h=(b.dataset||[]).map((function(e){var A="";try{A=e.formula instanceof Array?e.formula.map((function(e){return X(e,t,n)})):X(e.formula,t,n)}catch(e){}return{value:A,style:Object.assign(Object.assign({},b.cellStyles),e.style),rowspan:e.rowspan,colspan:e.colspan}}));z.data=Z([Z(h)],p)}else if(A.widgetType===e.AjfWidgetType.Image){var g=A,T=r;g.flag&&(T.flag=i.evaluateExpression(g.flag.formula,t)),g.icon&&(T.icon=i.evaluateExpression(g.icon.formula,t)),g.url&&(T.url=i.evaluateExpression(g.url.formula,t))}else if(A.widgetType===e.AjfWidgetType.ImageContainer){var O=A,x=r;O.flags&&(x.flags=O.flags instanceof Array?O.flags.map((function(e){return i.evaluateExpression(e.formula,t)})):i.evaluateExpression(O.flags.formula,t)),O.icons&&(x.icons=O.icons instanceof Array?O.icons.map((function(e){return i.evaluateExpression(e.formula,t)})):i.evaluateExpression(O.icons.formula,t)),O.urls&&(x.urls=O.urls instanceof Array?O.urls.map((function(e){return i.evaluateExpression(e.formula,t)})):i.evaluateExpression(O.urls.formula,t))}else if(A.widgetType===e.AjfWidgetType.Text){for(var y=r,P=/\[{2}(.+?)\]{2}/g,E=[],M=void 0,W=A.htmlText;M=P.exec(W);){var I=M.index,G=M[0].length,R=i.createFormula({formula:M[1]});E.push({idx:I,len:G,formula:R})}E.reverse().forEach((function(e){var A;try{A=i.evaluateExpression(e.formula.formula,t)}catch(e){A=""}W=""+W.substr(0,e.idx)+A+W.substr(e.idx+e.len)})),y.htmlText=null!=W&&W.length>0?n.instant(W):W}else if(A.widgetType===e.AjfWidgetType.Formula)r.formula=i.evaluateExpression(A.formula.formula,t);else if(A.widgetType===e.AjfWidgetType.Map)r.coordinate=i.evaluateExpression(A.coordinate.formula,t);else if(A.widgetType>100){var q=null!=Y[A.widgetType]?Y[A.widgetType].initInstance:null;if(null!=q)return q(r,t,n)}return r}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
     ...
     * If not, see http://www.gnu.org/licenses/.
     *
     */function B(e,A,t){var n=e.content.map((function(e){return V(e,A,t)}));return{container:e,content:n,styles:e.styles}}
/**
     * @license
     * Copyright (C) Gnucoop soc. coop.
     *
...
/**
     ...
     *
     */
e.AjfAggregationSerializer=E,e.AjfBaseWidgetComponent=j,e.AjfDatasetSerializer=M,e.AjfGetColumnContentPipe=z,e.AjfReportContainerSerializer=G,e.AjfReportRenderer=p,e.AjfReportSerializer=R,e.AjfReportStringIdentifierPipe=h,e.AjfReportWidget=q,e.AjfReportsModule=x,e.AjfWidgetExport=y,e.AjfWidgetHost=O,e.AjfWidgetSerializer=I,e.AjfWidgetService=Q,e.chartToChartJsType=m,e.createAggregation=P,e.createReportInstance=function U(e,A,t){return(e.variables||[]).forEach((function(e){A[e.name]=i.evaluateExpression(e.formula.formula,A)})),{report:e,header:e.header?B(e.header,A,t):void 0,content:e.content?B(e.content,A,t):void 0,footer:e.footer?B(e.footer,A,t):void 0,styles:e.styles||{}}},e.createReportPdf=L,e.createWidget=W,e.createWidgetInstance=N,e.openReportPdf=function J(e,A){L(e,A).then((function(e){e.open()}))},e.widgetToWidgetInstance=V,Object.defineProperty(e,"__esModule",{value:!0})}));