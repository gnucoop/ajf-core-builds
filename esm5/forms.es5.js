...
AjfBaseFieldComponent = /** @class */ (function () {
    function AjfBaseFieldComponent(_changeDetectorRef, _service, _warningAlertService) {
         ...
         * @return {?}
         */
        function () { return _this._service.getControl(_this.instance).pipe(map((/**
         * @param {?} ctrl
         * @return {?}
         */
        function (ctrl) { return ctrl || new FormControl(); }))); }));
    }
...
function createNode(node) {
    ...
    var conditionalBranches = node.conditionalBranches != null && node.conditionalBranches.length > 0 ?
        ...
        [alwaysCondition()];
    return __assign({}, node, { parentNode: node.parentNode != null ? node.parentNode : 0, label: node.label || '', visibility: node.visibility || alwaysCondition(), conditionalBranches: conditionalBranches });
}
...
function createFieldInstance(instance, context) {
    ...
    return __assign({}, nodeInstance, { node: instance.node, value: value, valid: false, defaultValue: instance.defaultValue != null ? instance.defaultValue : null, validationResults: instance.validationResults || [], warningResults: instance.warningResults || [], warningTrigger: new EventEmitter(), updated: new EventEmitter() });
}
...
function createFieldWithChoicesInstance(instance, context) {
    ...
    return __assign({}, fieldInstance, { node: instance.node, filteredChoices: instance.node.choices.slice(), firstTriggerConditionDone: {}, selectionTrigger: new EventEmitter() });
}
...
var AjfFormRendererService = /** @class */ (function () {
    ...
    function (formGroup) {
        ...
        this._formGroupSubscription =
            formGroup.valueChanges
                .pipe(startWith({}), pairwise(), debounceTime(200), withLatestFrom.apply(void 0, (this._nodesMaps).concat([this._flatNodes])))
                .subscribe((/**
             * @param {?} v
             * @return {?}
             */
            function (v) {
                 ...
                 * @return {?}
                 */
                function (n) { return n.updatedEvt.emit(); }));
                if (initForm) {
                    initForm = false;
    ...
    function () {
         ...
         * @return {?}
         */
        function (nodes) { return flattenNodesInstancesTree(nodes); })), share());
...
var AjfNodeSerializer = /** @class */ (function () {
    ...
    function (json, choicesOrigins, attachmentsOrigins) {
        ...
        obj.conditionalBranches =
             ...
             * @return {?}
             */
            function (c) { return AjfConditionSerializer.fromJson(c); }));
        switch (obj.nodeType) {
            case AjfNodeType.AjfField:
    ...
    function (json, choicesOrigins) {
        ...
        if (json.triggerConditions) {
             ...
             * @return {?}
             */
            function (t) { return AjfConditionSerializer.fromJson(t); }));
        }
