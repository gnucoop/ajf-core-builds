...
function COUNT_FORMS(forms, expression = 'true') {
    ...
    for (const form of forms) {
        ...
        for (const rep of allReps(form)) {
            if (evaluateExpression(expression, Object.assign(Object.assign({}, form), rep))) {
                count++;
                break;
            }
        }
...
function COUNT_FORMS_UNIQUE(forms, field, expression = 'true') {
    ...
    for (const form of forms) {
        ...
        for (const rep of allReps(form)) {
            if (rep[field] != null && evaluateExpression(expression, Object.assign(Object.assign({}, form), rep))) {
...
function getNumericValues(forms, field, expression = 'true') {
    ...
    for (const form of forms) {
        ...
        for (const rep of allReps(form)) {
            const val = rep[field];
            if (val != null && !isNaN(Number(val)) && evaluateExpression(expression, Object.assign(Object.assign({}, form), rep))) {
                values.push(Number(val));
            }
        }
    }
