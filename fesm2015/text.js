...
import { Input, Component, ViewEncapsulation, ChangeDetectionStrategy, ChangeDetectorRef, NgModule } from '@angular/core';
...
let AjfTextModule = /** @class */ (() => {
    let AjfTextModule = class AjfTextModule {
    };
    AjfTextModule = __decorate([
        NgModule({
            imports: [
                CommonModule,
                TranslateModule,
