...
AjfCheckboxGroupModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "15.0.4", ngImport: i0, type: AjfCheckboxGroupModule, declarations: [AjfCheckboxGroup], imports: [FormsModule], exports: [AjfCheckboxGroup] });
AjfCheckboxGroupModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "15.0.4", ngImport: i0, type: AjfCheckboxGroupModule, imports: [FormsModule] });
