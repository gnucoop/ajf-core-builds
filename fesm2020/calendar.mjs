...
AjfCalendarEntryLabelPipe.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.0.0-next.15", ngImport: i0, type: AjfCalendarEntryLabelPipe, deps: [{ token: AjfCalendarService }], target: i0.ɵɵFactoryTarget.Pipe });
...
AjfCalendar.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.0.0-next.15", ngImport: i0, type: AjfCalendar, deps: [{ token: i0.ChangeDetectorRef }, { token: AjfCalendarService }], target: i0.ɵɵFactoryTarget.Directive });
