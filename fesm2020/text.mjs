...
AjfTextModule.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.0.0-rc.3", ngImport: i0, type: AjfTextModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
AjfTextModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.0.0-rc.3", ngImport: i0, type: AjfTextModule, declarations: [AjfTextComponent], imports: [CommonModule, AjfTranslocoModule], exports: [AjfTextComponent] });
AjfTextModule.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "13.0.0-rc.3", ngImport: i0, type: AjfTextModule, imports: [[CommonModule, AjfTranslocoModule]] });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.0.0-rc.3", ngImport: i0, type: AjfTextModule, decorators: [{
            type: NgModule,
            args: [{
