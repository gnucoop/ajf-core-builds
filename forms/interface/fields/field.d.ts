...
export declare type AjfField<T = any> = AjfBarcodeField | AjfBooleanField | AjfDateField | AjfDateInputField | AjfEmptyField | AjfFieldWithChoices<T> | AjfFileField | AjfFormulaField | AjfGeolocationField | AjfImageField | AjfMultipleChoiceField<T> | AjfNumberField | AjfRangeField | AjfSingleChoiceField<T> | AjfStringField | AjfTableField | AjfTextField | AjfTimeField;
