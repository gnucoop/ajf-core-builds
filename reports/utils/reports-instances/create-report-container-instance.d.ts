...
export declare function createReportContainerInstance(container: AjfReportContainer, context: AjfContext, ts: TranslocoService, variables?: AjfReportVariable[]): AjfReportContainerInstance;
